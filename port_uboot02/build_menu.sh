...
echo "[4/4] compiling menu..."
make menuconfig HOSTCC=gcc HOSTLDFLAGS="-L/usr/lib/aarch64-linux-gnu -lncurses -ltinfo" \
                 CURSES_LIBS="-L/usr/lib/aarch64-linux-gnu -lncurses -ltinfo"
echo "=============================="
