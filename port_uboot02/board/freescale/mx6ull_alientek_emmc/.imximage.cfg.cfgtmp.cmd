cmd_board/freescale/mx6ull_alientek_emmc/imximage.cfg.cfgtmp := arm-linux-gnueabihf-gcc -E -Wp,-MD,board/freescale/mx6ull_alientek_emmc/.imximage.cfg.cfgtmp.d -nostdinc -isystem /usr/lib/gcc-cross/arm-linux-gnueabihf/15/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -D__ARM__ -marm -mno-thumb-interwork  -mabi=aapcs-linux  -mword-relocations  -fno-pic  -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9  -msoft-float  -pipe  -march=armv7-a   -x c -o board/freescale/mx6ull_alientek_emmc/imximage.cfg.cfgtmp board/freescale/mx6ull_alientek_emmc/imximage.cfg

source_board/freescale/mx6ull_alientek_emmc/imximage.cfg.cfgtmp := board/freescale/mx6ull_alientek_emmc/imximage.cfg

deps_board/freescale/mx6ull_alientek_emmc/imximage.cfg.cfgtmp := \
...
board/freescale/mx6ull_alientek_emmc/imximage.cfg.cfgtmp: $(deps_board/freescale/mx6ull_alientek_emmc/imximage.cfg.cfgtmp)
